...
%gitexe% log -1 --date=format:%%Y.%%m.%%d --pretty=format:"#define MPCSS_REV_DATE %%ad%%n" >> revision.h
%gitexe% log -1 --pretty=format:"#define MPCSS_REV_HASH %%h%%n" >> revision.h

<nul set /p strTemp=#define MPCSS_REV_NUM >> revision.h
